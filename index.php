    ...
    <div class="login-container CENTERABS">
        ...
        <form action="index.php" method="GET">
            <div class="form-group">
                ...
                <input type="email" name="email" placeholder="example@gmail.com" required value= <?php echo $email ?>>
            </div>

            <div class="form-group">
                <label for="password">Password:</label>
                <input type="password" name="password" placeholder="Your Password" required value= <?php echo $password ?> >
            </div>
